...
export default function MainNavigation() {
  ...
  return (
    <>
      <motion.header
        className="w-full h-auto px-5 md:px-16 py-3  text-black  transition-all duration-300 ease-in-out"
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `relative flex flex-col items-center px-3 py-2 rounded-lg transition-colors duration-200 hover:bg-white hover:text-black hover:font-bold ${
                    isActive
                      ? "bg-white text-black"
                      : "text-white bg-black  hover:bg-silver hover:text-black hover:font-bold"
                  }`
                }
                end
              >
